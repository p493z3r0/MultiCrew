...
class PilotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post pilots_url, params: { pilot: { about: @pilot.about, hours: @pilot.hours, lastname: @pilot.lastname, name: @pilot.name, simulator: @pilot.simulator } }
    end
  ...
  test "should update pilot" do
    patch pilot_url(@pilot), params: { pilot: { about: @pilot.about, hours: @pilot.hours, lastname: @pilot.lastname, name: @pilot.name, simulator: @pilot.simulator } }
